...
const Nav = () => {
  ...
  return (
    <div
      className={`fixed w-full top-0 z-50 p-6 bg-bg-light transition-all duration-300 shadow-lg`}
    ...
    >
      <div className="flex justify-between items-center max-w-screen-lg mx-auto">
        ...
        <AnimatePresence>
          ...
          >
            <li>
              <a href="#expertise" onClick={() => setMenuOpen(false)} className="hover:text-orange-600">
                Services
              </a>
            </li>
            <li>
              <a href="#portfolio" onClick={() => setMenuOpen(false)} className="hover:text-orange-600">
                Projects
              </a>
            </li>
          </motion.ul>}
